...
public class ExistentialCuantifierConjunction implements NormalFormTransformationRuleFOL {
	...
	public boolean canApply(FOLFormula formula) {
		...
		if(left.charAt(0)!='E' && right.charAt(0)!='E')
		{
			return false;
		}
		return true;
	...
	public FOLFormula apply(FOLFormula formula) throws InvalidSubstitution {
		...
		if(formula.syntaxTree.getRoot().getLeftChild().getLabel().charAt(0)=='E')
		{
		...
		FOLTreeNode result=new FOLTreeNode("E"+toCuantify+".",newCuantifiedFormula,null);
